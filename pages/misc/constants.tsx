...
// TODO just dumping all the queen shit here, sort out later
/* 
//QUEENS:
//SEASON 1: 
...
export const teamNames = [
    ...
    {queenNames: ["Alexis Mateo", "Yara Sofia"], teamName: "Yarlexis"},
    {queenNames: ["Chad Michaels", "Shannel"], teamName: "Shad"},
    {queenNames: ["Nina Flowers", "Tammie Brown"], teamName: "Brown Flowers"},
    {queenNames: ["Jujubee", "Raven"], teamName: "Rujubee"},
    {queenNames: ["Mimi Imfurst", "Pandora Boxx"], teamName: "Mandora"}
];
